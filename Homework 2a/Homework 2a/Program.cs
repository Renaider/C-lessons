...
namespace Homework_2a
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Кол-во десятков " + v / 10);
            Console.WriteLine("Кол-во единиц " + v % 10);
            Console.WriteLine("Сумма его цифр " + ((v / 10) + (v % 10)));
            Console.WriteLine("Кол-во десятков " + (v / 10) * (v % 10));
            //A1.5
